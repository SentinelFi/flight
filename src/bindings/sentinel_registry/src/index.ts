 ...
 */
export type RegistryStorageKey = {tag: "Insurances", values: void} | {tag: "ByVertical", values: void} | {tag: "ByStatus", values: void} | {tag: "TotalCount", values: void};
...
export interface Client {
   ...
   */
  register: ({insurance, record}: {insurance: string, record: InsuranceRecord}, options?: {
    /**
   ...
   */
  update_status: ({insurance, new_status}: {insurance: string, new_status: PoolStatus}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_by_vertical: ({vertical}: {vertical: Vertical}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_by_status: ({status}: {status: PoolStatus}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_insurance: ({insurance}: {insurance: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  search: ({vertical, status, asset, after_timestamp, before_timestamp}: {vertical: Option<Vertical>, status: Option<PoolStatus>, asset: Option<string>, after_timestamp: Option<u64>, before_timestamp: Option<u64>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAIcmVnaXN0ZXIAAAACAAAAAAAAAAlpbnN1cmFuY2UAAAAAAAATAAAAAAAAAAZyZWNvcmQAAAAAB9AAAAAPSW5zdXJhbmNlUmVjb3JkAAAAAAEAAAAB",
  ...
  public readonly fromJSON = {
    register: this.txFromJSON<boolean>,
        update_status: this.txFromJSON<boolean>,
        get_all: this.txFromJSON<Array<InsuranceRecord>>,
        get_by_vertical: this.txFromJSON<Array<string>>,
        get_by_status: this.txFromJSON<Array<string>>,
        get_insurance: this.txFromJSON<Option<InsuranceRecord>>,
        get_active_count: this.txFromJSON<u32>,
        get_total_count: this.txFromJSON<u32>,
        search: this.txFromJSON<Array<InsuranceRecord>>
  }
}