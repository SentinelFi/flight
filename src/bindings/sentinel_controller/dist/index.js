...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAQAAAAAAAAACGRlcGxveWVyAAAAEwAAAAAAAAAFcG9vbHMAAAAAAAfQAAAADVBvb2xBZGRyZXNzZXMAAAAAAAAAAAAABm9yYWNsZQAAAAAAEwAAAAAAAAAGY29uZmlnAAAAAAfQAAAAEERlcGxveW1lbnRDb25maWcAAAAA",
    ...
    fromJSON = {
        buy_premium: (this.txFromJSON),
        underwrite: (this.txFromJSON),
        resolve: (this.txFromJSON),
        claim_premium_rewards: (this.txFromJSON),
        claim_underwrite_rewards: (this.txFromJSON),
        get_status: (this.txFromJSON),
        get_policy: (this.txFromJSON),
        get_policies_owned_by: (this.txFromJSON),
        pause: (this.txFromJSON),
        unpause: (this.txFromJSON),
        update_oracle: (this.txFromJSON),
        get_pools: (this.txFromJSON),
        get_total_premiums: (this.txFromJSON),
        get_total_coverage: (this.txFromJSON),
        get_underwrites: (this.txFromJSON),
        is_resolved: (this.txFromJSON),
        is_triggered: (this.txFromJSON),
